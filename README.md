...
repos:
  - repo: https://github.com/michen00/markdown-prose-hooks-rs
    rev: v0.1.4 # frozen once published; `pre-commit autoupdate` moves it
    hooks:
