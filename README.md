...
repos:
  - repo: https://github.com/michen00/markdown-prose-hooks-rs
    rev: v0.2.0 # frozen once published; `pre-commit autoupdate` moves it
    hooks:
